  ...
  return (
    <main className="flex flex-col min-h-fit w-full items-center justify-start">
      {bookPage ? (
        ...
        <div className="flex flex-col items-center justify-center p-10 align-top w-full">
          <button className="p-4 mb-8  border border-black bg-slate-300 duration-300 hover:opacity-30" onClick={bookHandler}>back</button>
